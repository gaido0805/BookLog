<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <!-- 作成フォーム -->
      <form @submit.prevent="createBook" class="bg-white rounded-xl shadow-lg p-8">
        <div class="space-y-8">
          <!-- タイトル -->
          <div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="8"
              required
              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-lg resize-none"
          ...
          <div class="flex space-x-4 pt-6">
            <button
              type="submit"
              :disabled="loading"
              class="flex-1 inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg shadow-lg hover:from-blue-700 hover:to-indigo-700 transform hover:scale-105 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
